/**
 * Contract checks for request options, whitespace normalization, duplicate
 * filtering, and rejection of malformed geocoder coordinates.
 */
...
/** Injects a canned geocoder response and records calls through a Vitest spy. */
