/**
 * Checks the explorer's curated destination catalog and item-ID helpers.
 * The tests protect stable preset keys and finite start positions while
 * ensuring malformed or unknown input never selects a substitute scene.
 */
