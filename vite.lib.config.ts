/**
 * Builds the embeddable component as an ESM library. SDK modules remain peer
 * dependencies; a mode selects the compatible ArcGIS SDK distribution family.
 */
import { defineConfig } from "vite";

const sdkTargets = new Set(["4.30", "4.32", "5.1"]);

/** Validate the selected SDK mode and return the matching library output settings. */
