/**
 * Checks the smallest public demo in a browser, including visible rendering,
 * accessible host behavior, and ownership of ArcGIS layers and listeners.
 * Stop/restart paths must release flight resources while preserving the host.
 */
...
/** Checks that flight adds one scene layer, renders real pixels, and cleans up host state. */
