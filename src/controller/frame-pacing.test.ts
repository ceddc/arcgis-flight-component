/**
 * Guards the frame pacing window that informs camera submission cadence.
 * The suite checks its sample threshold, rolling average/p95, and reset after
 * invalid or suspended-frame durations.
 */
