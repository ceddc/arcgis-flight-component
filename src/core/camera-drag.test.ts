/**
 * Guards temporary chase-camera drag and return behavior independently of ArcGIS.
 * The cases cover release and recapture continuity, frame-rate consistency,
 * orbit geometry at extreme offsets, and terrain clearance.
 */
