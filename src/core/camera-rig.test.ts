/**
 * Guards SDK-independent chase/cockpit camera calculations.
 * The suite checks reversible transitions, heading wraparound, pilot-eye
 * placement, and speed-sensitive chase framing/FOV.
 */
...
describe("camera transition and framing", () => {
  ...
  it("blends heading through north and keeps the aircraft fully framed", () => {
    // 350 -> 10 should take the short path across north instead of rotating almost a full turn.
