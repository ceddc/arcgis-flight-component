/**
 * Exercise ArcGIS SDK compatibility behind injectable module loaders.
 * Checks version-specific glTF/projection API selection, lazy loading and
 * propagation of module or projection failures to the caller.
 */
