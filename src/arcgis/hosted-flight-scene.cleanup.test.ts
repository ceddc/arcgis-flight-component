/**
 * Lifecycle tests for the hosted ArcGIS session using SDK-shaped test doubles.
 * They verify teardown, borrowed-state restoration, async cancellation and
 * single-camera submission ownership without constructing a live WebGL scene.
 */
...
function createScene(options: {
  ...
  const view = {
    ...
    constraints: { clipDistance: { mode: "auto", near: 10, far: 100_000 } },
