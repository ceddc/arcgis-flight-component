/**
 * Verify ownership-aware restoration of a caller's ArcGIS view settings.
 * Cleanup restores the original value only while the component's applied
 * value remains current, leaving later caller edits intact.
 */
