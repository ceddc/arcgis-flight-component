/**
 * Simulate scene pointer gestures bound to the flight camera orbit controller.
 * Covers pointer capture, control exclusion, multi-touch cancellation and
 * listener/style cleanup so host navigation can resume after teardown.
 */
