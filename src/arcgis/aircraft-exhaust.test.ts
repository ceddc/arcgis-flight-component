/**
 * Check the afterburner plume's time-based animation and nozzle offset.
 * Advances it at different frame rates and through thrust changes, including
 * reduced-motion behavior, to keep presentation independent of render cadence.
 */
