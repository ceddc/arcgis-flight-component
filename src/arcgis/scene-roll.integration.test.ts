/**
 * Integration-level RenderNode wiring tests with a mocked WebGL2 context.
 * They cover attachment forwarding, shared-context restoration, lazy allocation
 * and the level-viewport fallback when shader/node setup fails.
 */
