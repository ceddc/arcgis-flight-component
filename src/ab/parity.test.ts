/**
 * Replays checked-in fixed-step captures to detect changes in flight/camera behavior.
 * The fixture data lives with this package, so these comparisons do not need
 * access to the source repository recorded in the fixture metadata.
 */
