/**
 * Guards UI language detection and translation for all supported locales.
 * The cases check explicit/browser fallback order, regional number-format tags,
 * complete control text, and placeholder substitution without shared state.
 */
