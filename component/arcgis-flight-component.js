...
var YP = (e, A, P) => A in e ? OP(e, A, { enumerable: !0, configurable: !0, writable: !0, value: P }) : e[A] = P;
var w = (e, A, P) => YP(e, typeof A != "symbol" ? A + "" : A, P);
import { onLocaleChange as yP, getLocale as GP } from "@arcgis/core/intl.js";
import * as qe from "@arcgis/core/kernel.js";
import { version as fP } from "@arcgis/core/kernel.js";
import Oe from "@arcgis/core/Camera.js";
import UP from "@arcgis/core/Graphic.js";
import { isAbortError as rP } from "@arcgis/core/core/promiseUtils.js";
import * as kP from "@arcgis/core/core/reactiveUtils.js";
import wP from "@arcgis/core/geometry/Point.js";
import * as RP from "@arcgis/core/geometry/support/webMercatorUtils.js";
import FP from "@arcgis/core/layers/GraphicsLayer.js";
import aP from "@arcgis/core/symbols/FillSymbol3DLayer.js";
import nP from "@arcgis/core/symbols/MeshSymbol3D.js";
import SP from "@arcgis/core/geometry/support/MeshTransform.js";
import { subclass as xP } from "@arcgis/core/core/accessorSupport/decorators.js";
import NP from "@arcgis/core/views/3d/webgl/RenderNode.js";
...
const cP = 0.8, lP = 65, st = !0, fe = 78, Ue = 3.5, it = 1, h = {
  fixedStepSeconds: 1 / 60,
  maxCatchUpSteps: 4,
  cruiseSpeed: 100,
  minimumSpeed: 48,
...
function Ne(e, A) {
  return !IP.has(e) || A === "editable" ? !1 : A !== "activation" || !Ut.has(e);
}
function FA(e) {
  var P;
...
function ws(e) {
  ...
  for (const t of e)
    t.shading = "source", t.trustSourceNormals = !0, is(t.material) && A.add(t.material);
  for (const t of A)
...
async function ui(e, A) {
  ...
  if (P !== void 0 && t !== void 0) {
    ...
    if (i.isWebMercator)
      return RP.geographicToWebMercator(s);
...
async function Ci(e, A, P = {}) {
  ...
  try {
    ...
    if (a.add(z), D === "web-mercator" && o.viewingMode === "global" && o.whenLayerView(z).then((B) => {
      M || (T = As(B, qe.fullVersion ?? qe.version), l.add("aircraft render origin", Y.runtime, () => T == null ? void 0 : T.destroy()));
    }, () => {
    ...
    const GA = new ys({
      ...
      onError(B) {
        rP(B) || console.warn("ArcGIS flight presentation failed.", B);
      }
    });
...
class zi {
  ...
  constructor(A, P) {
    ...
    `, this.stick = A.createElement("button"), this.stick.type = "button", this.stick.disabled = !0, t.append(s, this.stick), this.binding = mi(this.stick, P);
  }
...
class LP extends HTMLElement {
  ...
  bindLocaleChange() {
    this.localeChangeHandle || (this.localeChangeHandle = yP(() => {
  ...
  syncControlsUi(P, t, s) {
    ...
    const r = this.ownerDocument.defaultView, a = this.getAttribute("locale") ?? t.ui.locale, o = GP(), n = {
      locale: a === "auto" ? o : a,
...
export {
  ...
  oP as ARCGIS_PLANE_NAVIGATION_TAG,
  LP as ArcgisPlaneNavigationElement,
  Lt as DEFAULT_AIRCRAFT_ASSETS,
  CP as DEFAULT_FLIGHT_LOCALE,
  EP as DEFAULT_PLANE_NAVIGATION_CONFIG,
  Ni as FLIGHT_LANGUAGE_NAMES,
  Bt as FLIGHT_MESSAGES,
  zP as PLANE_NAVIGATION_UI_CONTROLS,
  Tt as PLANE_NAVIGATION_UI_POSITIONS,
  nt as SUPPORTED_FLIGHT_LOCALES,
  Hi as createFlightTranslator,
  Mt as detectFlightFormatLocale,
  dt as detectFlightLocale,
  Et as flightCameraModeActionLabel,
  zt as flightCameraModeLabel,
  mt as flightPowerModeActionLabel,
  Xi as flightPowerModeAriaLabel,
  Re as flightPowerModeLabel,
  ee as flightText,
  bt as isPlaneNavigationUiControl,
  HA as isPlaneNavigationUiPosition,
  DA as mergePlaneNavigationConfig,
  bA as normalizePlaneNavigationConfig,
  jP as normalizePlaneNavigationUiControls,
  ut as resolveFlightFormatLocale,
  Ct as resolveFlightLocale,
