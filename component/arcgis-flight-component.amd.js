define(['module', 'require', 'exports', 'esri/intl', 'esri/kernel', 'esri/Camera', 'esri/Graphic', 'esri/core/promiseUtils', 'esri/core/reactiveUtils', 'esri/geometry/Point', 'esri/geometry/support/webMercatorUtils', 'esri/layers/GraphicsLayer', 'esri/symbols/FillSymbol3DLayer', 'esri/symbols/MeshSymbol3D', 'esri/geometry/support/MeshTransform', 'esri/core/accessorSupport/decorators', 'esri/views/3d/webgl/RenderNode'], (function (module, require, exports, intl_js, qe, Oe, UP, promiseUtils_js, kP, wP, RP, FP, aP, nP, SP, decorators_js, NP) { 'use strict';
  ...
  var qe__namespace = /*#__PURE__*/_interopNamespaceDefault(qe);
  var kP__namespace = /*#__PURE__*/_interopNamespaceDefault(kP);
  var RP__namespace = /*#__PURE__*/_interopNamespaceDefault(RP);

  var OP = Object.defineProperty;
  var YP = (e, A, P) => A in e ? OP(e, A, { enumerable: true, configurable: true, writable: true, value: P }) : e[A] = P;
  var w = (e, A, P) => YP(e, typeof A != "symbol" ? A + "" : A, P);
  ...
  const Ye = 78, ye = 3.5, XP = 1, lA = {
    ...
    pitchLevelResponse: Math.log(Ye / XP) / ye,
    bankResponse: 3.2,
  ...
  function WP(e, A, P, t = lA.pitchInputResponse) {
    const s = v(A, -1, 1);
  ...
  function JP(e, A, P, t = lA.turboMaximumSpeed, s = lA) {
  ...
  function _P(e, A, P) {
    ...
    const s = v(A.pitch, -1, 1), i = v(A.bank, -1, 1), r = v(A.yaw, -1, 1), a = Math.max(v(A.brake, 0, 1), Math.max(0, s)), o = a > 0.01 ? 0 : Math.max(v(A.accelerate, 0, 1), Math.max(0, -s)), [n, D] = fA(
      ...
      H.minimum,
      H.maximum
    ), O = ZP(e.speed, q, q > e.speed ? 1.65 : 1.6, t), T = (e.speed + O) / 2, Q = (e.bank + z) / 2 * S, b = 1 / Math.cos(Q), G = v((g - 0.65) / 0.35, 0, 1), y = (0.85 + 8e-3 * (T - KP) ** 2 + 0.45 * l ** 2 + 0.65 * G ** 2) * b ** 1.2, f = v(
  ...
  const cP = 0.8, lP = 65, st = true, fe = 78, Ue = 3.5, it = 1, h = {
    fixedStepSeconds: 1 / 60,
    maxCatchUpSteps: 4,
    cruiseSpeed: 100,
    minimumSpeed: 48,
    ...
    pitchLevelResponse: Math.log(fe / it) / Ue,
    bankResponse: 3.2,
    bankLevelResponse: 4.6,
    bankTurnAssistDeg: 62,
    yawRateDeg: 60,
  ...
  function rt(e, A, P, t = 1, s = h.turboMaximumSpeed) {
    const i = v(P, 0, 0.1), r = BP(t), a = v(A.pitch, -1, 1), o = v(A.bank, -1, 1), n = v(A.yaw, -1, 1), D = v(A.accelerate, 0, 1), g = v(Math.max(A.brake, A.airbrake ? 1 : 0), 0, 1), u = A.turboBoost && g < 0.05 ? 1 : 0, l = a * h.maximumPitchDeg, C = o * h.maximumBankDeg, d = v(
      LA(
        e.pitch,
        l,
  ...
  const nt = ["en", "de", "fr", "it", "es"], CP = "en", Ni = {
    en: "English",
    de: "Deutsch",
    fr: "Français",
    it: "Italiano",
  ...
  function dt(e = {}) {
    const A = e.documentLanguage === void 0 ? dP() : e.documentLanguage, P = e.navigatorLanguages === void 0 ? MP() : e.navigatorLanguages ?? [], t = e.navigatorLanguage === void 0 ? hP() : e.navigatorLanguage, s = e.intlLocale === void 0 ? mP() : e.intlLocale;
  ...
  const Pe = 2e5, jt = 2.2, UA = (e, A, P, t) => A + (e - A) * Math.exp(-P * t);
  function It(e, A, P, t) {
    const s = v(P, 0, 0.1);
    ...
    const i = v(A.pitch, -1, 1), r = v(A.bank, -1, 1), a = v(A.yaw, -1, 1), o = v(A.brake, 0, 1), n = !!A.turboBoost && o < 0.05, D = o < 0.05 ? v(A.accelerate, 0, 1) : 0, g = n ? t.turboMaximumSpeed : v(
      ...
      t.maximumTurnRateDeg
    ), y = e.spaceTurnRate ?? 0, f = G * y < 0 ? 4.8 : jt, k = Math.abs(G) < 0.01 ? 0 : UA(y, G, f, s), R = Math.abs(G) < 0.01 ? 0 : G + (y - G) * (1 - Math.exp(-f * s)) / (f * s), L = AA(e.heading + R * s), F = (e.heading + R * s / 2) * S, Z = v(k / t.bankTurnAssistDeg, -1, 1) * t.maximumBankDeg;
    return {
      driftAngle: 0,
      cornerAssist: 0,
      position: {
  ...
  function Qt(e, A, P, t) {
    ...
    return e.model === "paraglider" ? _P(A, s, t) : e.model === "space-jet" ? It(A, s, t, e.tuning) : (e.model === "super-jet" && s.brake > 0.05 && (s.accelerate = 0), JP(A, s, t, e.tuning.turboMaximumSpeed, e.tuning));
  }
  ...
  function jP(e) {
    return Array.from(new Set(e.filter(bt)));
  }
  function Vt(e, A) {
  ...
  function bA(e = {}, A = EP) {
    ...
    const D = e.flight === void 0 ? A.flight : e.flight, g = D ? pt(D) : null;
    ...
    return {
      ...
      camera: {
        ...
        fovDeg: v(Number(i.fovDeg) || lP, 58, 76),
        bankedViewport: i.bankedViewport !== false,
        submissionHz: v(Number(i.submissionHz) || 60, 30, 60)
      },
      controls: {
        keyboard: r.keyboard !== false,
        gamepad: r.gamepad !== false,
        sensitivity: v(
          Number(r.sensitivity) || cP,
          0.5,
          2
        ),
        invertPitch: r.invertPitch !== false,
        captureSceneNavigation: r.captureSceneNavigation !== false
      },
      terrain: {
      ...
      ui: {
        ...
        showSpeed: o.showSpeed === true,
        locale: Vt(o.locale, A.ui.locale)
      },
  ...
  class ft {
    ...
    constructor(A, P, t = {}) {
      ...
      w(this, "stepIndex", 0);
      w(this, "pausedState", false);
      if (this.stepPhysics = P, this.fixedStepSeconds = t.fixedStepSeconds ?? Yt, this.maxCatchUpSteps = t.maxCatchUpSteps ?? yt, !Number.isFinite(this.fixedStepSeconds) || this.fixedStepSeconds <= 0)
    ...
    pause() {
      return this.pausedState = true, this.clearTimingRemainder(), this.createFrame(0, 0);
    }
    /** Resumes with a clean timing baseline, avoiding a jump on the next display frame. */
    resume() {
      return this.pausedState = false, this.clearTimingRemainder(), this.createFrame(0, 0);
    }
    ...
    createFrame(A, P) {
      ...
      return {
        ...
        renderPose: Gt(this.previous, this.current, t),
        interpolationAlpha: t,
        simulatedSteps: A,
  ...
  const IP = /* @__PURE__ */ new Set([
    ...
    "ArrowRight",
    "Space"
  ]), kt = "input, select, textarea, [contenteditable]:not([contenteditable='false']), [role='textbox']", Rt = "button, a, [role='button'], [role='menuitem'], [role='radio']", XA = 0.18, Se = 0.28, gA = {
    attackResponse: 3.2,
  ...
  function St(e, A, P, t = XA) {
    ...
    const r = (a) => Ft(
      a,
      (P == null ? void 0 : P.has(a.index)) ?? true
    );
    return s.filter((a) => r(a) >= t).sort((a, o) => r(o) - r(a))[0] ?? null;
  }
  function Ne(e, A) {
    return !IP.has(e) || A === "editable" ? false : A !== "activation" || !Ut.has(e);
  }
  function FA(e) {
    var P;
  ...
  function Xe(e) {
    const A = FA(e);
    return A.some((P) => He(P, kt)) ? "editable" : A.some((P) => He(P, Rt)) ? "activation" : "none";
  }
  function ie(e, A, P, t) {
  ...
  class Nt {
    ...
    constructor(A) {
      ...
      w(this, "controlPatch", {});
      w(this, "interactionOwned", false);
      w(this, "recoveryLatched", false);
      ...
      w(this, "gamepadAxesArmed", false);
      w(this, "menuPressed", false);
      w(this, "powerFasterPressed", false);
      w(this, "powerSlowerPressed", false);
      w(this, "destroyed", false);
      ...
      w(this, "handleKeyUp", (A) => {
        IP.has(A.code) && (this.keys.delete(A.code), A.code !== "KeyR" && (this.destroyed || A.isComposing || A.ctrlKey || A.metaKey || A.altKey || !this.resolveSettings().keyboardEnabled || !this.ownsInteraction(A) || !Ne(A.code, Xe(A)) || this.capture(A)));
      });
      w(this, "handlePointerDown", (A) => {
        const P = FA(A).includes(this.target);
        this.interactionOwned = P, P || (this.releaseKeyboard(), this.recoveryLatched = false);
      });
      ...
      w(this, "handleWindowBlur", () => {
        this.interactionOwned = false, this.setTouchStick(0, 0), this.releaseKeyboard(), this.recoveryLatched = false;
      });
      ...
      }), this.onPauseRequested = A.onPauseRequested, this.onRecoverRequested = A.onRecoverRequested, this.onPowerModeStepRequested = A.onPowerModeStepRequested, this.view.addEventListener("keydown", this.handleKeyDown, true), this.view.addEventListener("keyup", this.handleKeyUp, true), this.view.addEventListener("pointerdown", this.handlePointerDown, true), this.view.addEventListener("focusin", this.handleFocusIn, true), this.view.addEventListener("blur", this.handleWindowBlur), this.view.addEventListener("gamepadconnected", this.handleGamepadConnected), this.view.addEventListener("gamepaddisconnected", this.handleGamepadDisconnected), this.document.addEventListener("visibilitychange", this.handleVisibilityChange);
    }
    ...
    setControlPatch(A) {
      ...
      this.setNumericPatch(P, "pitch", A.pitch, -1, 1), this.setNumericPatch(P, "bank", A.bank, -1, 1), this.setNumericPatch(P, "yaw", A.yaw, -1, 1), this.setNumericPatch(P, "accelerate", A.accelerate, 0, 1), this.setNumericPatch(P, "brake", A.brake, 0, 1), this.setBooleanPatch(P, "turboBoost", A.turboBoost), this.setBooleanPatch(P, "airbrake", A.airbrake), A.respawn === true && this.requestRecovery(), this.controlPatch = P;
    }
    /** Removes all host overrides or selected fields; recovery is a one-shot latch. */
    clearControlPatch(A) {
      if (!A) {
        this.controlPatch = {}, this.recoveryLatched = false;
        return;
      }
      const P = { ...this.controlPatch };
      for (const t of A)
        t === "respawn" ? this.recoveryLatched = false : delete P[t];
      this.controlPatch = P;
    }
    ...
    requestRecovery() {
      var A;
      this.destroyed || (this.recoveryLatched = true, (A = this.onRecoverRequested) == null || A.call(this));
    }
    ...
    sample(A = 1 / 60) {
      ...
      return this.recoveryLatched = false, { ...l, ...this.controlPatch };
    }
    /** Releases held keys, pointer/gamepad ownership, touch values, and host overrides. */
    clear() {
      this.releaseKeyboard(), this.setTouchStick(0, 0), this.controlPatch = {}, this.recoveryLatched = false, this.interactionOwned = false, this.releaseGamepad(), this.gamepadAxesReady.clear();
    }
    /** Removes installed listeners and clears held input; safe to call more than once. */
    destroy() {
      this.destroyed || (this.destroyed = true, this.view.removeEventListener("keydown", this.handleKeyDown, true), this.view.removeEventListener("keyup", this.handleKeyUp, true), this.view.removeEventListener("pointerdown", this.handlePointerDown, true), this.view.removeEventListener("focusin", this.handleFocusIn, true), this.view.removeEventListener("blur", this.handleWindowBlur), this.view.removeEventListener("gamepadconnected", this.handleGamepadConnected), this.view.removeEventListener("gamepaddisconnected", this.handleGamepadDisconnected), this.document.removeEventListener("visibilitychange", this.handleVisibilityChange), this.clear());
    }
    resolveSettings() {
      var A;
      return se({
    ...
    ownsInteraction(A) {
      if (this.document.visibilityState !== "visible" || !this.document.hasFocus())
        return false;
      if (A && FA(A).includes(this.target)) return true;
    ...
    pollGamepad(A, P) {
      ...
      !this.gamepadAxesArmed && Math.hypot(a, o) <= s && (this.gamepadAxesArmed = true);
    ...
    useGamepad(A) {
      ...
      this.gamepadSlot = (A == null ? void 0 : A.index) ?? null, this.gamepadId = (A == null ? void 0 : A.id) ?? null, this.gamepadMapping = (A == null ? void 0 : A.mapping) ?? null, this.gamepadAxesArmed = A ? this.gamepadAxesReady.has(A.index) : false, this.menuPressed = false, this.powerFasterPressed = false, this.powerSlowerPressed = false;
    }
    releaseGamepad() {
      this.useGamepad(null), this.gamepadAxesArmed = false, this.menuPressed = false, this.powerFasterPressed = false, this.powerSlowerPressed = false;
    }
    capture(A) {
      A.preventDefault(), A.stopPropagation();
    }
  }
  const Ht = 30, EA = 180, Xt = 250;
  class Wt {
    constructor() {
  ...
  class _t {
    ...
    constructor(A) {
      ...
      w(this, "framePacing", new Wt());
      w(this, "initialized", false);
      w(this, "destroyed", false);
      ...
      w(this, "onFrame", (A) => {
        ...
        this.runtime.paused && this.runtime.resume(), this.runtimeFrame = this.runtime.tick(A), !this.destroyed && this.phaseState === "running" && (this.present(false, t), A - this.lastSnapshotTime >= 50 && (this.lastSnapshotTime = A, this.emit())), this.requestNextFrame();
      });
    ...
    initialize() {
      ...
      const A = new Nt({
        ...
        onPowerModeStepRequested: (P) => {
          this.setPowerMode(tt(this.powerModeState, P));
        }
      });
      this.input = A;
      try {
    ...
    start(A = {}) {
      ...
      this.vehicle = aA(this.scene.startState), this.safeVehicle = aA(this.vehicle), this.smoothedPitchInput = 0, P.clear(), this.applyPowerModeToInput(P, this.powerModeState), this.phaseState = "running", A.focusScene && this.scene.sceneElement.focus(), this.runtimeFrame = this.runtime.reset(
        mA(this.vehicle),
        false
      ), this.present(true, h.fixedStepSeconds), this.emit(), this.startFrameLoop();
    }
    ...
    recover() {
      ...
      ), this.present(true, h.fixedStepSeconds), this.emit();
    }
    /** Changes chase/cockpit mode; `instant` skips the visual transition. */
    setCameraMode(A, P = false) {
      oe(A);
    ...
    async setAircraft(A) {
      ...
      if (!await this.scene.setAircraft(A.assets, A.flight) || this.destroyed || P !== this.aircraftRequest) return false;
      if (this.flightProfile = A.flight, this.minimumClearanceM = A.terrain.minimumClearanceM, this.maximumAglM = A.terrain.maximumAglM, t) {
        this.recoverSpeedMps = ((a = A.flight) == null ? void 0 : a.tuning.cruiseSpeed) ?? h.cruiseSpeed, this.vehicle = Zt(this.vehicle, A), this.safeVehicle = aA(this.vehicle), this.smoothedPitchInput = 0;
        const o = this.input;
      ...
      return this.present(t, h.fixedStepSeconds), this.emit(), true;
    }
    ...
    snapshot() {
      ...
      return {
        ...
        gamepad: ((s = this.input) == null ? void 0 : s.gamepadStatus) ?? Kt,
    ...
    destroy(A = {}) {
      ...
      this.destroyed = true, this.initialized = false, this.phaseState = "stopped", this.stopFrameLoop();
      const P = this.input;
    ...
    togglePause() {
      this.phaseState === "running" ? this.pause() : this.phaseState === "paused" && this.resume({ focusScene: true });
    }
    applyPowerModeToInput(A, P) {
      const t = Pt(P);
      A.clearControlPatch(["brake", "turboBoost"]), t.brake > 0 && A.setControlPatch({ brake: t.brake }), t.turboBoost && A.setControlPatch({ turboBoost: true });
    }
    ...
    applyLiveState(A, P = {}) {
      const t = this.requireInitializedInput(), s = {
        ...
        bankedViewport: this.bankedViewportState,
        powerMode: this.powerModeState
      }, i = s.cameraMode !== A.cameraMode || P.instantCamera === true, r = s.bankedViewport !== A.bankedViewport, o = (i || r || s.fovDegrees !== A.fovDegrees) && this.phaseState !== "running", n = s.powerMode !== A.powerMode;
      let D = false;
      try {
    ...
    simulateStep(A) {
      ...
      this.smoothedPitchInput = ((i = this.flightProfile) == null ? void 0 : i.model) === "space-jet" || ((r = this.flightProfile) == null ? void 0 : r.model) === "paraglider" ? A.pitch : this.flightProfile ? WP(this.smoothedPitchInput, A.pitch, h.fixedStepSeconds, this.flightProfile.tuning.pitchInputResponse) : ot(
        this.smoothedPitchInput,
        A.pitch,
        h.fixedStepSeconds
      );
      let t = this.flightProfile ? Qt(
        this.flightProfile,
        P,
      ...
      }), s !== null && t.position.z - s < this.minimumClearanceM ? t = wt(
        t,
        s,
    ...
    present(A, P, t = this.fovDegrees) {
      this.scene.present(
        qt(this.runtimeFrame.renderPose, this.vehicle),
        t,
        P,
  ...
  function $t(e, A, P) {
    ...
    const o = () => {
      ...
      !P() || s !== null || !["mouse", "touch"].includes(c.pointerType) || c.button !== 0 || c.altKey || c.ctrlKey || c.metaKey || c.shiftKey || (s = c.pointerId, r = c.clientX, a = c.clientY, A.begin(), e.setPointerCapture(s), e.focus({ preventScroll: true }), c.preventDefault());
    }, g = (c) => {
    ...
    return e.addEventListener("pointerdown", D, { capture: true }), e.addEventListener("pointermove", g, { capture: true }), e.addEventListener("lostpointercapture", l), window.addEventListener("pointerup", u, { capture: true }), window.addEventListener("pointercancel", u, { capture: true }), window.addEventListener("blur", C), document.addEventListener("visibilitychange", d), { reset: M, destroy() {
      M(), e.style.touchAction === "none" && (e.style.touchAction = t), e.removeEventListener("pointerdown", D, { capture: true }), e.removeEventListener("pointermove", g, { capture: true }), e.removeEventListener("lostpointercapture", l), window.removeEventListener("pointerup", u, { capture: true }), window.removeEventListener("pointercancel", u, { capture: true }), window.removeEventListener("blur", C), document.removeEventListener("visibilitychange", d);
    } };
  }
  ...
  class es {
    ...
    reset() {
      this.intensity = this.opacity = this.phase = this.surge = 0, this.lengthScale = 0.12, this.visible = false;
    }
  ...
  const pP = ts(qe.version, {
    async mesh() {
      return new Promise(function (resolve, reject) { require(['esri/geometry/Mesh'], function (m) { resolve(/*#__PURE__*/_interopNamespaceDefault(m)); }, reject); });
    },
    async meshUtils() {
      return new Promise(function (resolve, reject) { require(['esri/geometry/support/meshUtils'], function (m) { resolve(/*#__PURE__*/_interopNamespaceDefault(m)); }, reject); });
    },
    async projection() {
      return new Promise(function (resolve, reject) { require(['esri/geometry/projection'], function (m) { resolve(/*#__PURE__*/_interopNamespaceDefault(m)); }, reject); });
    },
    async projectOperator() {
      {
        const e = await new Promise(function (resolve, reject) { require(['esri/geometry/operators/projectOperator'], function (m) { resolve(/*#__PURE__*/_interopNamespaceDefault(m)); }, reject); });
        return {
          isLoaded: e.isLoaded,
          load: e.load,
  ...
  }), Ke = pP.createGltfMesh, ss = pP.projectPoint;
  function is(e) {
  ...
  function ws(e) {
    ...
    for (const t of e)
      t.shading = "source", t.trustSourceNormals = true, is(t.material) && A.add(t.material);
    for (const t of A)
      typeof ((P = t.color) == null ? void 0 : P.a) == "number" && t.color.a < 1 || os(t.color) < 0.15 || (t.roughness = rs(t));
  }
  const as = 6378137, ns = 1.05, Ds = 10, gs = 0.82, vs = 0.72;
  class cs {
    constructor() {
      w(this, "progress", 0);
    ...
    get zoomOffsetDegrees() {
      ...
      return this.targetMode === "cockpit" ? -13 * A : Ds * A;
    }
    ...
    update(A) {
      const P = this.targetMode === "cockpit" ? 1 : 0, t = v(A, 0, 0.1) / ns;
  ...
  function ls(e, A, P) {
    ...
    return {
      ...
      y: N(e.y, A.y, t),
      z: N(e.z, A.z, t),
      heading: DP(e.heading, A.heading, t),
  ...
  function ds(e, A, P = 1) {
    const t = gP(e.bodyHeading, e.pitch), s = 0.4;
    return {
  ...
  function ue(e) {
    const A = Math.max(-Math.PI, Math.min(Math.PI, e / as));
    return Math.cosh(A);
  }
  class ms {
    constructor(A = 0) {
  ...
  const SA = Math.PI / 180, js = 180 / Math.PI;
  function BA(e, A) {
  ...
  function Ts(e) {
    var t;
    const A = ((t = e.transform) == null ? void 0 : t.clone()) ?? new SP(), P = {
      transform: A,
      baseTranslation: [...A.translation],
      baseRotation: Is(A.rotationAxis, A.rotationAngle)
    };
  ...
  function Ys(e) {
    ...
    const c = 16, j = (m) => m ? Array.from({ length: c }, (I, q) => new nP({
      symbolLayers: [new aP({
        castShadows: false,
    ...
    return {
      ...
      setAircraft(m) {
        ...
        P = m.vehicle, t = m.propeller, s = m.boost, a = m.propellerAnchorM, o = m.visualPitchDeg, { scale: d, outletForwardM: M } = C(s), p = j(s), z = 0, l = false;
      },
  ...
  class ys {
    ...
    constructor(A) {
      ...
      this.intervalMs = _e(A.intervalMs ?? 1e3 / 30), this.toleranceMs = Math.max(0, A.toleranceMs ?? 0.25), this.now = A.now ?? (() => performance.now()), this.schedule = A.schedule ?? ((P, t) => window.setTimeout(P, t)), this.cancel = A.cancel ?? ((P) => window.clearTimeout(P)), this.submitFrame = A.submit, this.onError = A.onError ?? (() => {
      });
    }
    /**
     ...
     */
    update(A, P = false) {
      this.destroyed || (this.pending && (this.coalescedCount += 1), this.frame ? Object.assign(this.frame, A) : this.frame = { ...A }, this.pending = true, P && (this.clearTimer(), this.lastSubmitMs = Number.NEGATIVE_INFINITY), this.flush());
    }
    ...
    destroy() {
      this.destroyed = true, this.pending = false, this.frame = null, this.clearTimer();
    }
    ...
    flush() {
      ...
      this.clearTimer(), this.pending = false, this.submissionCount += 1, this.lastSubmitMs = this.now(), this.firstSubmitMs ?? (this.firstSubmitMs = this.lastSubmitMs);
      try {
  ...
  const De = 60, ge = 30, Gs = 5e3, fs = 4e3, Us = 50, ks = 25, Rs = 55, Fs = 22, Ss = 65;
  function xs(e) {
  ...
  class Ns {
    constructor() {
      w(this, "targetHz", De);
      w(this, "displaySynchronized", false);
     ...
     */
    update(A, P) {
      if (!(Number.isFinite(P) && P >= 0 && (this.lastSampleAtMs === null || P >= this.lastSampleAtMs)) || !xs(A))
        return this.invalidSampleCount += 1, this.lastSampleValid = false, this.lastSampleAtMs = null, this.pressureSinceMs = null, this.recoverySinceMs = null, this.diagnostics();
      this.lastSampleValid = true, this.lastSampleAtMs = P;
      const s = A.averageFps, i = A.p95FrameMs;
      return this.targetHz === ge ? (this.pressureSinceMs = null, s >= Rs && i <= Fs ? (this.recoverySinceMs ?? (this.recoverySinceMs = P), P - this.recoverySinceMs >= fs && (this.targetHz = De, this.degradedAtMs = null, this.recoveredAtMs = P, this.recoverySinceMs = null), this.updateDisplaySynchronization(s), this.diagnostics()) : (this.recoverySinceMs = null, this.diagnostics())) : (this.recoverySinceMs = null, s < Us && i > ks ? (this.pressureSinceMs ?? (this.pressureSinceMs = P), P - this.pressureSinceMs >= Gs && (this.targetHz = ge, this.degradedAtMs = P, this.recoveredAtMs = null, this.pressureSinceMs = null), this.updateDisplaySynchronization(s), this.diagnostics()) : (this.pressureSinceMs = null, this.updateDisplaySynchronization(s), this.diagnostics()));
    }
    ...
    updateDisplaySynchronization(A) {
      this.displaySynchronized = this.targetHz === De && A <= Ss;
    }
  }
  const pA = 0.85;
  class Hs {
    ...
    release() {
      this.held && (this.held = false, this.releaseYaw = this.yaw, this.releasePitch = this.pitch, this.returnElapsed = 0);
    }
    /** Clears drag state immediately, for snaps, mode changes, and teardown. */
    reset() {
      this.held = false, this.yaw = this.pitch = 0, this.returnElapsed = pA;
    }
  ...
  class Js {
    ...
    constructor(A, P, t = {
      ...
      w(this, "transition", new cs());
      w(this, "aircraft");
      w(this, "previousSpeed");
      w(this, "smoothedLongitudinalAcceleration", 0);
      w(this, "launchCameraKick", 0);
      this.aircraft = t, this.rig = new Es({
        distanceM: 17.5,
        heightM: 7.2,
        fovDegrees: P,
        headingDegrees: A.bodyHeading
      }), this.pitchSmoother = new ms(A.pitch), this.previousSpeed = A.speed;
    }
    ...
    update(A) {
      var R;
      const { pose: P, viewport: t } = A, s = A.snap === true, i = v(A.deltaSeconds, 1 / 240, 0.1);
      s && this.drag.reset();
      ...
      const l = this.rig.update(D, i, s), d = this.pitchSmoother.update(P.pitch, i, s) * Math.PI / 180, M = gP(l.headingDegrees, 0), c = A.webMercator ? ue(P.position.y) : 1, j = N(4.5, 9.5, o) + n * 8, p = {
      ...
      const b = ls(
        Q,
        ds(P, A.verticalFovDegrees, c),
        a
      ), G = Math.max(1, t.width) / Math.max(1, t.height), y = hs(
        v(b.fovDegrees + this.transition.zoomOffsetDegrees, 46, 100),
        G
      ), f = A.bankedViewport ? b.roll : 0, k = Math.abs(f) < 0.01 ? 1 : us(f, t.width, t.height) + 0.012;
      return {
        x: b.x,
        y: b.y,
        z: b.z,
...
`);
  ...
  function Ai(e, A, P) {
    ...
    try {
      if (t = $e(e, e.VERTEX_SHADER, A, "Scene roll vertex"), s = $e(e, e.FRAGMENT_SHADER, P, "Scene roll fragment"), i = e.createProgram(), !i) throw new Error("Unable to allocate scene-roll program.");
  ...
  class ti extends NP {
    ...
    ensureResources() {
      const P = this.gl;
      if (this.resourceGl && this.resourceGl !== P && (this.disposeResources(), this.disabled = false), this.program) return true;
      if (this.disabled) return false;
      try {
        if (this.resourceGl = P, this.program = Ai(P, _s, $s), this.vao = P.createVertexArray(), this.colorUniform = P.getUniformLocation(this.program, "uColor"), this.rollUniform = P.getUniformLocation(this.program, "uRollRadians"), this.viewportScaleUniform = P.getUniformLocation(this.program, "uViewportScale"), this.aspectRatioUniform = P.getUniformLocation(this.program, "uAspectRatio"), !this.vao || !this.colorUniform || !this.rollUniform || !this.viewportScaleUniform || !this.aspectRatioUniform)
          throw new Error("Unable to allocate scene-roll resources.");
        return !0;
      } catch (t) {
        return this.disabled = true, console.warn("ArcGIS scene-roll RenderNode disabled:", t), this.disposeResources(), false;
      }
    }
  }
  const si = decorators_js.subclass(
    "arcgisFlightComponent.SceneRollNode"
  )(ti);
  function ii(e, A) {
    let P = null, t = false, s = 0, i = 1;
    const r = () => {
      if (!A || t) return null;
      if (P) return P;
      try {
        return P = new si({ view: e }), P.setTransform(s, i), P;
      } catch (a) {
        return t = true, console.warn("ArcGIS scene-roll RenderNode unavailable; using a level viewport.", a), null;
      }
    };
    return r(), {
      /** True only while the enabled node can actually apply image roll. */
      get appliesRoll() {
        return A && !t && ((P == null ? void 0 : P.appliesRoll) ?? false);
      },
      ...
      destroy() {
        A = false, P == null || P.disposeResources(), P == null || P.destroy(), P = null;
      }
    };
  }
  async function oi(e, A, P) {
    var t, s;
    if (!e) return null;
    try {
      ...
      if (promiseUtils_js.isAbortError(i)) throw i;
      return null;
    }
  }
  async function AP(e, A, P, t, s = "global") {
    ...
    const a = /* @__PURE__ */ new Set(), o = /* @__PURE__ */ new Set(), n = (C) => {
      ...
      r || (r = true, a.forEach(n), a.clear(), i.abort(C));
    };
    let g = null;
    const u = t ? new Promise((C, d) => {
      g = () => {
        const M = t.reason;
        D(M), d(M);
      }, t.addEventListener("abort", g, { once: true });
    }) : null, l = async (C) => {
      try {
        const d = await e(A, C, {
          signal: i.signal,
  ...
  function NA(e) {
    return (e.equals ?? Object.is)(e.current, e.applied) ? (e.restore(e.original), true) : false;
  }
  const ni = 6378137, de = 25e3, Di = 2, gi = 16e4;
  function eP(e, A) {
    const P = Number.isFinite(e) ? Math.max(0, e) : 0, s = Math.sqrt(P * (2 * ni + P)) * 1.5 + 1e4;
    return Math.max(A, Math.ceil(s / de) * de);
  }
  function PP(e, A, P = Di) {
  ...
  function ci(e, A) {
    ...
    let i = PP(A, true), r = eP(A, s), a = 0;
    return e.constraints.clipDistance = { mode: "manual", near: i, far: r }, {
      update(o, n) {
        if (e.destroyed) return;
        const D = e.constraints.clipDistance, g = PP(o, n);
        D.near !== g && (D.near = g, i = g);
        const u = eP(o, s);
        vi(r, u) && (D.far = u, r = u, a += 1);
      },
      restore() {
        if (e.destroyed) return;
  ...
  const tP = "Plane navigation", QA = /* @__PURE__ */ new WeakMap(), Y = {
    runtime: 10,
    navigation: 20,
    camera: 30,
    layerRemoval: 40,
  ...
  async function ui(e, A) {
    ...
    if (P !== void 0 && t !== void 0) {
      ...
      if (i.isWebMercator)
        return RP__namespace.geographicToWebMercator(s);
      if (i.isWGS84) return s;
      const r = await ss(s, i);
      if (!r || r.type !== "point")
  ...
  async function Ci(e, A, P = {}) {
    const { signal: t } = P, s = P.restoreCameraOnAbort ?? (() => true), i = () => t == null ? void 0 : t.throwIfAborted();
    i();
    const r = At(e);
    await r.whenReady(), i();
    const a = r.map;
    if (!a) throw new Error("The referenced ArcGIS scene has no map.");
    const o = r.view, n = r.inputElement, D = bs(
      o.viewingMode,
      o.spatialReference
    ), g = Vs(D, o.spatialReference), u = Symbol("arcgis-plane-navigation");
    if (QA.has(o))
      throw new Error("This ArcGIS scene already has an active plane navigation instance.");
    QA.set(o, u);
    const l = new li(), C = new AbortController();
    ...
    try {
      j = o.camera.clone(), l.add("initial camera", Y.accessor, () => {
        ...
        actionMap: o.navigation.actionMap ? ri(o.navigation.actionMap) : null
      }, z = new FP({
        title: tP,
    ...
    let I = false;
    const q = (L) => L.preventDefault(), O = new Ns();
    ...
    try {
      ...
      const L = await ui(r, A);
      i();
      const F = A.terrain.enabled || A.start.altitudeM === void 0 ? await oi(
        a.ground,
        L,
        t
      ) : null;
      ...
      const oA = qs({ x: L.x, y: L.y, z: L.z }, g);
      F !== null && (b = {
        position: { x: oA.x, y: oA.y },
        elevationM: F,
        timestampMs: performance.now()
      });
      const OA = uP(oA, ve(A.start.headingDeg, o.camera.heading)), K = {
        ...OA,
        speed: ve(A.start.speedMps, OA.speed)
      };
      if (a.add(z), D === "web-mercator" && o.viewingMode === "global" && o.whenLayerView(z).then((B) => {
        M || (T = As(B, qe__namespace.fullVersion ?? qe__namespace.version), l.add("aircraft render origin", Y.runtime, () => T == null ? void 0 : T.destroy()));
      }, () => {
      ...
      const WA = (B, E) => {
        const V = new UP({
          geometry: B,
          symbol: new nP({
            symbolLayers: [new aP({ castShadows: E })]
          })
        });
        ...
        const [V, U, x] = B;
        return bP(B), E.preserveFinish || ws([
          ...V.components ?? [],
      ...
      }, JA = /* @__PURE__ */ new Map(), KA = /* @__PURE__ */ new Map(), me = (B) => JSON.stringify(B), VP = await AP(
        Ke,
        L,
        A.assets,
        t,
      ...
      const qP = 1e3 / A.camera.submissionHz, Ie = (B) => A.camera.submissionHz < 60 ? Math.max(qP, B.intervalMs) : B.intervalMs, yA = new Oe({
        position: L.clone(),
        heading: K.heading,
        tilt: 78
      });
      ...
      const hA = ii(o, A.camera.bankedViewport);
      l.add("scene roll", Y.runtime, () => hA.destroy());
      const rA = D === "web-mercator" && o.viewingMode === "global" ? ci(o, nA) : null;
      ...
      const GA = new ys({
        ...
        onError(B) {
          promiseUtils_js.isAbortError(B) || console.warn("ArcGIS flight presentation failed.", B);
        }
      });
      ...
      }, PA = A.controls.captureSceneNavigation ? $t(n, eA.drag, () => eA.canOrbit) : null;
      l.add("camera drag input", Y.runtime, () => PA == null ? void 0 : PA.destroy());
      const Qe = window.matchMedia("(prefers-reduced-motion: reduce)"), ZA = new es();
      ...
      throw c(
        t != null && t.aborted ? s() : true
      ), L;
    }
  }
  const MA = ["slow", "normal", "turbo"], di = `
  :host {
    display: block;
    color: #f7faf8;
    color-scheme: dark;
...
`;
  ...
  class hi {
    ...
    rebuild() {
      ...
      if (Mi(this.config.controls, "power")) {
    ...
    renderState() {
      ...
      for (const [t, s] of this.powerButtons) {
        ...
        s.disabled = P, s.setAttribute("aria-checked", String(i)), s.setAttribute(
          "aria-label",
          i ? Re(this.locale, t) : mt(this.locale, t)
        ), s.tabIndex = i ? 0 : -1;
      }
      ...
      if (this.cameraButton) {
        ...
        this.cameraButton.disabled = P, this.cameraButton.textContent = zt(this.locale, t);
        const s = Et(this.locale, t);
  ...
  function mi(e, A) {
    ...
    return e.addEventListener("pointerdown", o), e.addEventListener("pointermove", a), e.addEventListener("lostpointercapture", n), t.addEventListener("pointerup", n, true), t.addEventListener("pointercancel", n, true), t.addEventListener("blur", r), t.addEventListener("resize", r), P.addEventListener("visibilitychange", D), { reset: r, destroy() {
      r(), e.removeEventListener("pointerdown", o), e.removeEventListener("pointermove", a), e.removeEventListener("lostpointercapture", n), t.removeEventListener("pointerup", n, true), t.removeEventListener("pointercancel", n, true), t.removeEventListener("blur", r), t.removeEventListener("resize", r), P.removeEventListener("visibilitychange", D);
    } };
  }
  const sP = {
    en: "Flight joystick",
  ...
  class zi {
    ...
    `, this.stick = A.createElement("button"), this.stick.type = "button", this.stick.disabled = true, t.append(s, this.stick), this.binding = mi(this.stick, P);
    }
    /** Enable only during flight and reset an active gesture when flight stops. */
    update(A, P) {
      !A && !this.stick.disabled && this.binding.reset(), this.stick.disabled = !A, this.stick.setAttribute("aria-label", sP[P]), this.stick.title = sP[P];
    }
  ...
  function Ii(e, A) {
    ...
    switch (A) {
      ...
      case "ui-controls": {
        const t = P.split(/[\s,]+/).filter(Boolean), s = jP(t);
  ...
  function pi(e, A, P) {
    return A === "start-longitude" || A === "start-latitude" ? ji(e, A, P) : e.hasAttribute(A) ? Ii(e, A) : Qi(A);
  }
  function Qi(e) {
    const A = EP;
    switch (e) {
  ...
  const iP = "The referenced arcgis-scene encountered a content or rendering error.";
  function Li(e) {
    if (!e || typeof e != "object")
      return new Error(iP);
    const A = e, P = typeof A.message == "string" && A.message.trim() ? A.message : iP, t = new Error(P, { cause: e });
  ...
  const oP = "arcgis-plane-navigation";
  ...
  function ce(e, A) {
    return new Promise((P, t) => {
      ...
      A.addEventListener("abort", s, { once: true }), Promise.resolve(e).then(
        (i) => {
  ...
  function le(e) {
    var A;
    ((A = e.camera) == null ? void 0 : A.mode) !== void 0 && QP(e.camera.mode), e.powerMode !== void 0 && TP(e.powerMode);
  }
  class LP extends HTMLElement {
    constructor() {
      ...
      w(this, "onSceneReadyChange", () => {
        ...
        const { scene: t } = P, s = t.map ?? null, i = t.view ?? null, r = s !== P.map || i !== P.view, a = bi({
          ready: t.ready,
          transitionPending: P.transitionPending,
          identityChanged: r
        });
        if (a === "teardown") {
          P.transitionPending = true, this.cancelOperation("superseded", !r), this.destroySession(!r), this.setStatus("loading");
          return;
        }
        a !== "ignore" && (P.transitionPending = false, P.map = s, P.view = i, !(this.statusState === "loading" && this.operation) && this.beginInitialization(false));
      });
      /** Convert an ArcGIS fatal scene error, cancel pending work and publish the failure. */
      w(this, "onSceneReadyError", () => {
        const P = this.sceneBinding;
        if (!P || !this.isConnected) return;
        const { scene: t } = P, s = Li(t.fatalError), i = this.operation;
        i && (this.operation = null, i.controller.signal.aborted || i.controller.abort(s));
        const r = (t.map ?? null) !== P.map || (t.view ?? null) !== P.view;
        P.transitionPending = true, this.destroySession(!r), this.reportError(s);
      });
    }
    ...
    disconnectedCallback() {
      var P;
      (P = this.touchMedia) == null || P.removeEventListener("change", this.onTouchMediaChange), this.touchMedia = null, this.cancelOperation("disconnected", true), this.unbindSceneReadyChange(), this.unbindLocaleChange(), this.destroySession(true), this.setStatus("idle");
    }
    /**
    ...
    attributeChangedCallback(P, t, s) {
      if (t !== s) {
        ...
        try {
          const i = P === "start-longitude" || P === "start-latitude", r = pi(
            this,
            P,
            this.configState
          ), a = DA(
     ...
     */
    setCameraMode(P, t = false) {
      QP(P), this.applyConfigUpdate(
        { camera: { mode: P } },
        { instantCamera: t }
      );
    }
    ...
    setPowerMode(P) {
      TP(P), this.applyConfigUpdate({ powerMode: P });
    }
    /** Toggle turbo and return whether it is active; return false without a session. */
    toggleTurbo() {
      const P = this.session;
      return P ? (P.toggleTurbo(), this.session !== P ? false : (this.configState = DA(this.configState, {
    ...
    async setAircraft(P) {
      ...
      if (!i)
        return this.configState = s, this.isConnected && this.beginInitialization(), false;
    ...
    applyConfigUpdate(P, t = {}) {
      le(P);
      const s = this.configState, i = DA(s, P), r = Ti(s, i);
      if (!this.session || r) {
      ...
      const n = a.snapshot(), D = s.camera.mode !== i.camera.mode || s.powerMode !== i.powerMode || t.instantCamera === true, g = this.sessionHost;
      if (D && g) {
    ...
    async initializeOperation(P, t) {
      try {
        ...
        if (!t) return;
        const i = "tagName" in t ? vP(t) : $P(t), r = i.scene, a = P.controller.signal;
        ...
        throw this.operation !== P ? this.operationError(P, s) : (this.destroySession(true), this.reportError(s));
      }
    }
    /** Subscribe to ArcGIS locale changes while automatic UI localization is active. */
    bindLocaleChange() {
      this.localeChangeHandle || (this.localeChangeHandle = intl_js.onLocaleChange(() => {
    ...
    reportError(P) {
      ...
      return this.setStatus("error"), this.dispatchEvent(new CustomEvent(
        ...
        { detail: { error: t }, bubbles: true, composed: true }
      )), t;
    }
    ...
    publishSessionSnapshot(P, t, s) {
      return !this.isConnected || this.session !== t ? false : (s.phase === "running" ? this.setStatus("running") : s.phase === "paused" && this.setStatus("paused"), this.syncControlsUi(P, this.configState, s), this.dispatchEvent(new CustomEvent(
    ...
    syncControlsUi(P, t, s) {
      var l, C, d;
      const i = t.ui.joystick === "always" || t.ui.joystick === "auto" && ((l = this.touchMedia) == null ? void 0 : l.matches) === true;
      if (!P || !t.ui.enabled && !i) {
        this.unmountJoystick(), this.unmountControlsUi();
        return;
      }
      const r = this.ownerDocument.defaultView, a = this.getAttribute("locale") ?? t.ui.locale, o = intl_js.getLocale(), n = {
        locale: a === "auto" ? o : a,
      ...
      if (i ? (this.joystickOverlay ?? (this.joystickOverlay = new zi(
        this.ownerDocument,
        (M, c) => {
          var j;
      ...
      this.controlsOverlay || (this.controlsOverlay = new hi(
        this.ownerDocument,
        t.ui,
        D,
        g,
  ...
  w(LP, "observedAttributes", Ei);
  customElements.get(oP) || customElements.define(
    oP,
    LP
  );

  exports.AIRCRAFT_FLIGHT_PROFILES = tA;
  exports.ARCGIS_PLANE_NAVIGATION_TAG = oP;
  exports.ArcgisPlaneNavigationElement = LP;
  exports.DEFAULT_AIRCRAFT_ASSETS = Lt;
  exports.DEFAULT_FLIGHT_LOCALE = CP;
  exports.DEFAULT_PLANE_NAVIGATION_CONFIG = EP;
  exports.FLIGHT_LANGUAGE_NAMES = Ni;
  exports.FLIGHT_MESSAGES = Bt;
  exports.PLANE_NAVIGATION_UI_CONTROLS = zP;
  exports.PLANE_NAVIGATION_UI_POSITIONS = Tt;
  exports.SUPPORTED_FLIGHT_LOCALES = nt;
  exports.createFlightTranslator = Hi;
  exports.detectFlightFormatLocale = Mt;
  exports.detectFlightLocale = dt;
  exports.flightCameraModeActionLabel = Et;
  exports.flightCameraModeLabel = zt;
  exports.flightPowerModeActionLabel = mt;
  exports.flightPowerModeAriaLabel = Xi;
  exports.flightPowerModeLabel = Re;
  exports.flightText = ee;
  exports.isPlaneNavigationUiControl = bt;
  exports.isPlaneNavigationUiPosition = HA;
  exports.mergePlaneNavigationConfig = DA;
  exports.normalizePlaneNavigationConfig = bA;
  exports.normalizePlaneNavigationUiControls = jP;
  exports.resolveFlightFormatLocale = ut;
  exports.resolveFlightLocale = Ct;
  exports.supportedFlightLocale = qA;
  exports.translateFlightMessage = iA;
